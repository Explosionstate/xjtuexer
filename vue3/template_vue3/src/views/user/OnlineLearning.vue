...
export default {
  ...
  setup() {
    ...
    const getCardGradient = (name) => ({
      '思想道德与法治': 'linear-gradient(135deg, #8fa8c8 0%, #6b87a8 100%)',
      '中国近现代史纲要': 'linear-gradient(135deg, #c8a08f 0%, #a87868 100%)',
      '形势与政策': 'linear-gradient(135deg, #a8c88f 0%, #88a868 100%)',
      '马克思主义基本原理': 'linear-gradient(135deg, #c88f8f 0%, #a86868 100%)',
      '毛泽东思想和中国特色社会主义理论体系概论': 'linear-gradient(135deg, #8fc8c8 0%, #68a8a8 100%)',
      '习近平新时代中国特色社会主义思想概论': 'linear-gradient(135deg, #c8c88f 0%, #a8a868 100%)',
      '国家安全教育': 'linear-gradient(135deg, #a88fc8 0%, #8868a8 100%)',
      '工程伦理与科技报国': 'linear-gradient(135deg, #8fa8c8 0%, #6b87a8 100%)',
    }[name] || 'linear-gradient(135deg, #9ab0a0 0%, #7a9080 100%)');
    ...
    return {
      ...
      getCourseIcon, getCardGradient, getTagStyle, getCourseTag, getCourseLevel,
