const rawWorkspaceBaseUrl = import.meta.env.VITE_AGENT_WORKSPACE_URL || 'http://127.0.0.1:5174/'
export const AGENT_WORKSPACE_BASE_URL = rawWorkspaceBaseUrl.endsWith('/')
  ? rawWorkspaceBaseUrl
  : `${rawWorkspaceBaseUrl}/`
